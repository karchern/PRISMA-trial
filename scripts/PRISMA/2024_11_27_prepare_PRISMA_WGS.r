...
# This comes from 2024_06_14_prepare_PRISMA.r
outcomeInformation <- read_csv(
...
profiles %>%
    ...
    select(-sampleID) %>%
    write_csv(
        here('data/PRISMA_WGS_profiles.csv')
    )
...
# outcomeInformation %>%
#     write_tsv(
#         here('data/PRISMA_16S_meta_251123.tsv')
#     )
...
#     select(-sampleID) %>%
#     write_tsv(
#         here('data/PRISMA_16S_profiles_251123.tsv')
#     )
